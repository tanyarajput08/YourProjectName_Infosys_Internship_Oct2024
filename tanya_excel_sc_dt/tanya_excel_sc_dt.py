...
try:
        ...
        for face_encoding in face_encodings:
            ...
            if distance < confidence_threshold:
                ...
                if last_recognition_time is None or (now - last_recognition_time) >= entry_duration:
                    ...
                    # Log a new entry for Tanya Chauhan with screenshot
                ...
                # Draw a rectangle around the face and label it as tanya Chauhan
    ...
    if not df.empty:
        df.to_excel('attendance_with_screenshotsdate.xlsx', index=False)
        print("Attendance and screenshots saved to 'attendance_with_screenshotsdate.xlsx'.")
